...
- **Subtraction** (`-`)
- **Multiplication** (`*`)
  - Native method (for numbers < 50,000 bytes)
  - Karatsuba method (for numbers ≥ 50,000 bytes, **default**)
  - Fast Fourier Transform (FFT) method (for numbers ≥ 50,000 bytes)
- **Division** (`/`)
  - Native method (for numbers < 50,000 bytes)
  - Newton-Raphson method (for numbers ≥ 50,000 bytes)
- **Remainder** (`%`)
  - Native method (for numbers < 50,000 bytes)
  - Newton-Raphson method (for numbers ≥ 50,000 bytes)
